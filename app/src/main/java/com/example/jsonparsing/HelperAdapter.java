...
public class HelperAdapter extends RecyclerView.Adapter<HelperAdapter.MyViewClass> {
    ...
    public HelperAdapter(ArrayList<String> name, ArrayList<String> road_type, ArrayList<String> road_route_name, ArrayList<Float> latitude, ArrayList<Float> longitude, ArrayList<String> gas_station, ArrayList<String> lpg_charge, ArrayList<String> electric_charge,Context context) {
        this.name = name;
